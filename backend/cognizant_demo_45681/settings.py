"""
Django settings for cognizant_demo_45681 project.
...
ROOT_URLCONF = 'cognizant_demo_45681.urls'
...
WSGI_APPLICATION = 'cognizant_demo_45681.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cognizant_demo_45681 API",
    "DESCRIPTION": "API documentation for cognizant_demo_45681 App",
    "VERSION": "v1",
}
